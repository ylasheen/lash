    ...
    <>
      ...
      <div className="hero">
        ...
        <div className="left-panel">
          <div className="left-inner lg-strong" />
          <div className="left-content">
            <nav className="nav">
              ...
              <button className="menu-btn lg-light">
            ...
            <div className="hero-center">
              <div className="big-logo">
                <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="1.2">
                  ...
                  <circle cx="12" cy="8" r="2" fill="rgba(255,255,255,0.4)" stroke="none"/>
                </svg>
              </div>
              ...
              <button className="cta-btn lg-strong">
              ...
              <div className="pills">
                {["Artistic Gallery", "AI Generation", "3D Structures"].map(p => (
                  <div key={p} className="pill lg-light">{p}</div>
                ))}
              </div>
            </div>
        ...
        <div className="right-panel">
          <div className="right-top">
            <div className="social-pill lg-light">
              <a className="icon-circle" href="#"><TwitterIcon /></a>
              <a className="icon-circle" href="#"><LinkedinIcon /></a>
              <a className="icon-circle" href="#"><InstagramIcon /></a>
              <div className="icon-circle"><ArrowRight size={14} /></div>
            </div>
            <button className="account-btn lg-light">
              ...
              <div className="bottom-feature-card lg-strong">
                <div className="flower-thumb">
                  <svg width="60" height="50" viewBox="0 0 60 50" fill="none">
                    ...
                    <line x1="30" y1="27" x2="30" y2="42" stroke="rgba(255,255,255,0.3)" strokeWidth="1.5"/>
                  </svg>
                </div>
